...
sim.Send_Joint(   jointID  = 0, firstObjectID=0, secondObjectID=1, x=-2*WHEEL_RADIUS, y=-2*WHEEL_RADIUS, z=WHEEL_RADIUS, n1=1, n2=0, n3=0, lo=-1.0, hi=+1, positionControl = False)
